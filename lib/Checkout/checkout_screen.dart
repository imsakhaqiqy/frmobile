...
import 'package:field_recruitment/Checkout/camera_screen.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //final LatLng _kMapYour = LatLng(lat, long);
    ...
    Future _saveCheckout() async {
      loadingScreen(context);
      setState(() {
        visible = true;
      });
      var url =
          'https://www.nabasa.co.id/api_field_recruitment_v1/services.php/saveCheckout';
        ...
        children: <Widget>[
          Card(
            ...
            child: Padding(
              ...
              child: Text(
                'Check Out dapat dilakukan setiap hari mulai pukul 17.00 - 19.00 WIB.',
                style: TextStyle(
                  color: Colors.white,
                ),
              ),
